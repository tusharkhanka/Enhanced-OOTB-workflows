 ...
 *
 */
public class CustomWorkflowUtilList {
	...
	private static Log logger = LogFactory.getLog(CustomWorkflowUtilList.class);
	...
	public NodeRef getTemplateNodeRef(String templatePATH) {
		...
		logger.debug("In CustomWorkflowUtilList getTemplateNodeRef() method");
	 ...
	 */
	public void sendMail(String templatePATH, List<String> groupName,
			Map<String, Object> templateModel, String subject) {

		logger.debug("In CustomWorkflowUtilList sendMail() method");
...
/*	public List<Map<String, String>> getAttachedDocsList(NodeRef packageNodeRef) {
		...
		logger.debug("In CustomWorkflowUtilList getAttachedDocsList() method");
		...
		for (ChildAssociationRef childAssociationRef : lResources) {
			...
			logger.debug("Printing stringNodeRef " + stringNodeRef);
			
			String link = "page/site/";
	 ...
	 * @param packageNodeRef - noderef of the current workflow in progress
	 */
	public void prepareReminderMail1List(String workflowDescription,
			String templatePATH, List<String> groupName, String taskId,
			String initiator, String subject, NodeRef packageNodeRef) {

		logger.debug("In CustomWorkflowUtilList prepareReminderMail1() method");
